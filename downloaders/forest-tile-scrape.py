...
def download_tiles(zoom_levels, lat_min, lat_max, lon_min, lon_max, url_template, save_dir, api_key):
    headers = {
...
api_key = "790297f13b5a48d19be41fcc43383998"

download_tiles(
    zoom_levels=range(5, 16),
    lat_min=lat_min,
    lat_max=lat_max,
    lon_min=lon_min,
    lon_max=lon_max,
    url_template="https://tile.thunderforest.com/outdoors/{z}/{x}/{y}.png?apikey={key}",
    save_dir="./thunderforest_outdoors_tiles",
    api_key=api_key
)
